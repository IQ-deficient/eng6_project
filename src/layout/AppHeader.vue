    ...
    <header class="header-global">
        <base-nav class="navbar-main" transparent type="" effect="light" expand>
            <router-link slot="brand" class="navbar-brand mr-lg-3" to="/">
                <!-- <img
                    src="img/brand/1200px-Flag_of_Montenegro.svg.png"
                    alt="Montenegro"
                /> -->
                <h3
                    class="text- font-weight-heavy mb-3"
                    style="color: red; text-shadow: 2px 2px 4px #000000; "
                >
                    Montenegro
                </h3>
            </router-link>
                    ...
                    <div class="dropdown-menu-inner">
                        ...
                        >
                            ...
                            <div class="media-body ml-3">
                                ...
                                >
                                    Get started with Bootstrap, the world's most
                                    popular framework for building responsive
                                    sites.
                                </p>
                            </div>
                        </a>
                        ...
                        >
                            ...
                            <div class="media-body ml-3">
                                ...
                                <p
                                    class="description d-none d-md-inline-block mb-0"
                                >
                                    Learn how to use Argon compiling Scss,
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                <li class="nav-link">
                    <router-link
                        to="/south"
                        class="nav-link nav-link-icon text-primary zoom"
                        >South</router-link
                    >
                    <!-- <a
